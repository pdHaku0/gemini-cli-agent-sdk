...
export class AcpWebSocketTransport extends EventEmitter {
    ...
    private async resolveWebSocketConstructor(): Promise<any | null> {
        if (this.options.webSocketCtor) return this.options.webSocketCtor;
    ...
    private async openWebSocket() {
        ...
        try {
            ...
            const handleMessage = async (eventOrData: any) => {
                try {
